...
def pad_message(image: numpy.ndarray, message: numpy.ndarray) -> numpy.ndarray:
    """
    Pad the message array with 0s to match the size of the image array.
    ...
    Returns:
        A numpy array of the same dtype and starting elements than message, with the
        size of image.
    """
    return numpy.pad(message, (0, image.size - message.size))
